...
# ==== Base64 Encode Static Images ====
def encode_image_base64(path):
    with open(path, "rb") as f:
        return base64.b64encode(f.read()).decode()

dobby_path = os.path.join(STATIC_DIR, "dobby.png")
background_path = os.path.join(STATIC_DIR, "background.jpg")

dobby_base64 = encode_image_base64(dobby_path)
background_base64 = encode_image_base64(background_path)
...
with gr.Blocks() as demo:
    ...
    <img id='dobby' src='data:image/png;base64,{dobby_base64}' alt='Dobby'>
    """)
